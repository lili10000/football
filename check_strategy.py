...
class checkStartegy():
    def __init__(self):
        ...
        self.startegy['韩甲挑']=data(time=80,score=2,small_do="",else_do="买大球")  
        self.startegy['冰岛女甲']=data(time=80,score=2,small_do="",else_do="买大球")  
        self.startegy['智利乙']=data(time=80,score=2,small_do="",else_do="买大球")  
        self.startegy['中超']=data(time=80,score=2,small_do="",else_do="买大球")  


        self.startegy['印IFA盾']=data(time=80,score=1,small_do="",else_do="买大球")  
        self.startegy['韩国女K']=data(time=80,score=1,small_do="",else_do="买大球")  


        self.startegy['瑞典北甲']=data(time=80,score=0,small_do="",else_do="买大球")
        ...
        self.startegy['爱沙杯']=data(time=80,score=0,small_do="",else_do="买大球")
